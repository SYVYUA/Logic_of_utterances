...
public class SecondPracticeLesson2 extends AppCompatActivity {

    LinearLayout targetBox1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_practice_lesson2);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ch3P.isChecked()){
                    intent = new Intent(SecondPracticeLesson2.this, SecondPracticeLesson3.class);
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (dragEvent){
                ...
                case DragEvent.ACTION_DROP:
                    if (view.getId()==R.id.oR && v.getId()==R.id.target1){
